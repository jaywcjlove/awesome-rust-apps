...
- [RustFS](https://github.com/rustfs/rustfs) <img align="bottom" height="13" src="https://badgen.net/github/stars/rustfs/rustfs?style=flat&label=" /> <img align="bottom" height="13" src="https://img.shields.io/github/last-commit/rustfs/rustfs?style=flat&label=" /> - 用 Rust 编写的高性能、分布式、S3 兼容对象存储系统，可作为 MinIO 的平替。
...
- [Look](https://github.com/kunkka19xx/look) <img align="bottom" height="13" src="https://badgen.net/github/stars/kunkka19xx/look?style=flat&label=" /> <img align="bottom" height="13" src="https://img.shields.io/github/last-commit/kunkka19xx/look?style=flat&label=" /> - 跨平台、键盘优先、本地优先的桌面启动器，支持离线搜索、纯键盘操作并注重隐私保护。
...
- [Lap](https://github.com/julyx10/lap) <img align="bottom" height="13" src="https://badgen.net/github/stars/julyx10/lap?style=flat&label=" /> <img align="bottom" height="13" src="https://img.shields.io/github/last-commit/julyx10/lap?style=flat&label=" /> - 支持 AI 搜索、人脸识别、重复照片清理及 RAW 和视频管理的本地照片管理器。
...
- [Gridvana](https://github.com/osdodo/gridvana) <img align="bottom" height="13" src="https://badgen.net/github/stars/osdodo/gridvana?style=flat&label=" /> <img align="bottom" height="13" src="https://img.shields.io/github/last-commit/osdodo/gridvana?style=flat&label=" /> - 支持通过 MCP 实现人类与 AI Agent 协同创作的像素画与像素动画编辑器。
- [Kiri](https://github.com/yuxino/kiri) <img align="bottom" height="13" src="https://badgen.net/github/stars/yuxino/kiri?style=flat&label=" /> <img align="bottom" height="13" src="https://img.shields.io/github/last-commit/yuxino/kiri?style=flat&label=" /> - 集截图、标注、OCR 与录屏于一体的本地工具。
